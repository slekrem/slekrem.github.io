...
})({"4VbKx":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 55422;
...
var _sdk = require("@getalby/sdk");
var _walletManagerJs = require("./wallet-manager.js");
var _priceManagerJs = require("./price-manager.js");
var _stabilizationManagerJs = require("./stabilization-manager.js");
// Main Application Class
class NWCApp {
    constructor(){
        this.walletManager = new (0, _walletManagerJs.WalletManager)();
        this.priceManager = new (0, _priceManagerJs.PriceManager)();
        this.stabilizationManager = new (0, _stabilizationManagerJs.StabilizationManager)(this.walletManager);
...
},{"@getalby/sdk":"9bLk3","./wallet-manager.js":"cZjL6","./price-manager.js":"hlYsv","./stabilization-manager.js":"iDngy"}],"9bLk3":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CHF", ()=>Me);
parcelHelpers.export(exports, "EUR", ()=>Ae);
parcelHelpers.export(exports, "FiatAmount", ()=>Ie);
parcelHelpers.export(exports, "GBP", ()=>Ce);
parcelHelpers.export(exports, "JPY", ()=>Ue);
parcelHelpers.export(exports, "LN", ()=>Oe);
parcelHelpers.export(exports, "LNClient", ()=>Oe);
parcelHelpers.export(exports, "ReceiveInvoice", ()=>qe);
parcelHelpers.export(exports, "SATS", ()=>Se);
parcelHelpers.export(exports, "USD", ()=>xe);
parcelHelpers.export(exports, "nwc", ()=>Ee);
parcelHelpers.export(exports, "oauth", ()=>K);
parcelHelpers.export(exports, "resolveAmount", ()=>Re);
parcelHelpers.export(exports, "webln", ()=>de);
var _nostrTools = require("nostr-tools");
var _lightningTools = require("@getalby/lightning-tools");
function h(e, t) {
...
var se = /*#__PURE__*/ function() {
    function c(n) {
        this.relay = void 0, this.relayUrl = void 0, this.secret = void 0, this.lud16 = void 0, this.walletPubkey = void 0, this.options = void 0, this._encryptionType = void 0, n && n.nostrWalletConnectUrl && (n = d({}, c.parseWalletConnectUrl(n.nostrWalletConnectUrl), n)), this.options = d({}, n || {}), this.relayUrl = this.options.relayUrl, this.relay = new (0, _nostrTools.Relay)(this.relayUrl), this.options.secret && (this.secret = this.options.secret.toLowerCase().startsWith("nsec") ? (0, _nostrTools.nip19).decode(this.options.secret).data : this.options.secret), this.lud16 = this.options.lud16, this.walletPubkey = this.options.walletPubkey.toLowerCase().startsWith("npub") ? (0, _nostrTools.nip19).decode(this.options.walletPubkey).data : this.options.walletPubkey, void 0 === globalThis.WebSocket && console.error("WebSocket is undefined. Make sure to `import websocket-polyfill` for nodejs environments");
    }
    ...
    return a.getNostrWalletConnectUrl = function(e) {
        ...
        return Promise.resolve((0, _nostrTools.finalizeEvent)(e, H(this.secret)));
    }, a.getEventHash = function(e) {
        return (0, _nostrTools.getEventHash)(e);
    }, a.close = function() {
        ...
        try {
            ...
            var s = function() {
                if ("nip04" === r.encryptionType) return Promise.resolve((0, _nostrTools.nip04).encrypt(r.secret, e, t)).then(function(e) {
                    n = e;
                });
                var s = (0, _nostrTools.nip44).getConversationKey(H(r.secret), e);
                n = (0, _nostrTools.nip44).encrypt(t, s);
            }();
        ...
        try {
            ...
            if (!r.secret) throw new Error("Missing secret");
            var s = function() {
                if ("nip04" === r.encryptionType) return Promise.resolve((0, _nostrTools.nip04).decrypt(r.secret, e, t)).then(function(e) {
                    n = e;
                });
                var s = (0, _nostrTools.nip44).getConversationKey(H(r.secret), e);
                n = (0, _nostrTools.nip44).decrypt(t, s);
            }();
            return Promise.resolve(s && s.then ? s.then(function() {
                return n;
            }) : n);
        ...
        void 0 === t && (t = {}), n = n || J((0, _nostrTools.generateSecretKey)()), t.name || (t.name = document.location.host);
        var r = this.getAuthorizationUrl(e, t, (0, _nostrTools.getPublicKey)(H(n))), o = window.outerHeight / 2 + window.screenY - 300, i = window.outerWidth / 2 + window.screenX - 200;
        ...
        },
        {
            ...
            get: function() {
                if (!this.secret) throw new Error("Missing secret key");
                return (0, _nostrTools.getPublicKey)(H(this.secret));
            }
        },
        {
            key: "encryptionType",
...
var Pe = /*#__PURE__*/ function() {
    function t(t) {
        if (this.options = void 0, this.appSecretKey = void 0, this.relay = void 0, this.appSecretKey = t.appSecretKey || J((0, _nostrTools.generateSecretKey)()), this.options = d({}, t, {
            appPubkey: (0, _nostrTools.getPublicKey)(H(this.appSecretKey))
        ...
        this.relay = new (0, _nostrTools.Relay)(this.options.relayUrl), void 0 === globalThis.WebSocket && console.error("WebSocket is undefined. Make sure to `import websocket-polyfill` for nodejs environments");
    }
    var n = t.prototype;
...
var ke = /*#__PURE__*/ function() {
    function t(t) {
        this.relay = void 0, this.relayUrl = void 0, this.relayUrl = t.relayUrl, this.relay = new (0, _nostrTools.Relay)(this.relayUrl), void 0 === globalThis.WebSocket && console.error("WebSocket is undefined. Make sure to `import websocket-polyfill` for nodejs environments");
    }
    var r = t.prototype;
    return r.publishWalletServiceInfoEvent = function(e, t, n) {
        ...
        return Promise.resolve((0, _nostrTools.finalizeEvent)(e, H(t)));
    }, r.close = function() {
        return this.relay.close();
    }, r.encrypt = function(e, t, n) {
        try {
            var r, s = function() {
                if ("nip04" === n) return Promise.resolve((0, _nostrTools.nip04).encrypt(e.walletSecret, e.clientPubkey, t)).then(function(e) {
                    r = e;
                });
                var s = (0, _nostrTools.nip44).getConversationKey(H(e.walletSecret), e.clientPubkey);
                r = (0, _nostrTools.nip44).encrypt(t, s);
            }();
            return Promise.resolve(s && s.then ? s.then(function() {
                return r;
            }) : r);
        ...
        try {
            var r, s = function() {
                if ("nip04" === n) return Promise.resolve((0, _nostrTools.nip04).decrypt(e.walletSecret, e.clientPubkey, t)).then(function(e) {
                    r = e;
                });
                var s = (0, _nostrTools.nip44).getConversationKey(H(e.walletSecret), e.clientPubkey);
                r = (0, _nostrTools.nip44).decrypt(t, s);
            }();
            return Promise.resolve(s && s.then ? s.then(function() {
                return r;
            }) : r);
    ...
    NWCWalletServiceKeyPair: function(e, t) {
        ...
        this.walletPubkey = (0, _nostrTools.getPublicKey)(H(this.walletSecret));
    },
    NWCWalletService: ke
};
function Te(e, t, n) {
...
var qe = /*#__PURE__*/ function() {
    function e(e, t) {
        this.transaction = void 0, this.invoice = void 0, this._nwcClient = void 0, this._unsubscribeFunc = void 0, this._timeoutFunc = void 0, this._timeoutId = void 0, this.transaction = t, this.invoice = new (0, _lightningTools.Invoice)({
            pr: t.invoice
        }), this._nwcClient = e;
    }
    var t = e.prototype;
            ...
            var r = function(t) {
                function r(e) {
                    return Promise.resolve(o.nwcClient.payInvoice(d({}, n || {}, {
                        ...
                        return d({}, e, {
                            invoice: new (0, _lightningTools.Invoice)({
                                pr: i
                            })
                        });
                    });
                ...
                var s = function() {
                    if (i.indexOf("@") > -1) {
                        ...
                        var r = new (0, _lightningTools.LightningAddress)(e);
    ...
    this.satoshi = void 0, this.satoshi = (0, _lightningTools.fiat).getSatoshiValue({
        amount: e,
        currency: t
    });
}, xe = function(e) {
...
},{"nostr-tools":"cN4zr","@getalby/lightning-tools":"7tvw6","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cN4zr":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "nip17", ()=>nip17_exports);
...
parcelHelpers.export(exports, "nip54", ()=>nip54_exports);
...
__export(utils_exports, {
    ...
    bytesToHex: ()=>(0, _utils.bytesToHex),
    hexToBytes: ()=>(0, _utils.hexToBytes),
...
var AbstractSimplePool = class {
    ...
    subscribeMap(requests, params) {
        ...
        const allOpened = Promise.all(requests.map(async ({ url, filter }, i2)=>{
            url = normalizeURL(url);
            let relay;
            try {
...
function decode(code) {
    let { prefix, words } = (0, _base.bech32).decode(code, Bech32MaxSize);
...
function wrapManyEvents2(senderPrivateKey, recipients, message, conversationTitle, replyTo) {
    ...
    return [
        ...
        ...recipients
    ].map((recipient)=>wrapEvent2(senderPrivateKey, recipient, message, conversationTitle, replyTo));
}
...
},{"@noble/curves/secp256k1":"8NuVo","@noble/hashes/utils":"fuxLy","@noble/hashes/sha256":"h9cuS","@scure/base":"cd7yM","@noble/ciphers/aes":"lnaDd","@noble/ciphers/chacha":"lXF0m","@noble/ciphers/utils":"k0xcN","@noble/hashes/hkdf":"5Xutc","@noble/hashes/hmac":"higgt","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8NuVo":[function(require,module,exports,__globalThis) {
"use strict";
...
},{"a89c1505decc763e":"evFvC","362802f5a451efcb":"kvvwZ","6a274edd04635854":"1jGup","4687d8e71912c9bd":"lULXb","49209a65a14a4a44":"fc0Wi","992867e7d1ef8b":"7mgY5","8a5ef77428763709":"aB8tU"}],"evFvC":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"f3b7e1099e3dffe3":"9GEA2","2582a2a48878bf64":"kvvwZ"}],"9GEA2":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"e80023f7971138b1":"hurZQ","127a2bcc8b9148b":"kvvwZ"}],"hurZQ":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"kvvwZ":[function(require,module,exports,__globalThis) {
"use strict";
...
},{"68fd839c1f011a30":"43pci"}],"43pci":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"1jGup":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"lULXb":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"d8b1615c256fe3fa":"1jGup","aae491f09795d5ee":"fc0Wi","11f68d725b0f6f5d":"gtZZm"}],"gtZZm":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"72c8f755a25fddc3":"1jGup","f90fcba6ea31de55":"fc0Wi"}],"7mgY5":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"eccb35e649679ca":"1jGup","202487820f28c009":"fc0Wi"}],"aB8tU":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"2bb3ed73a71161e3":"hT9zp","808050cc11f056c7":"kvvwZ","bceff96a5b87336d":"lULXb"}],"hT9zp":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"6b524da50970d987":"hurZQ","54bb4061811e0f46":"kvvwZ"}],"fuxLy":[function(require,module,exports,__globalThis) {
"use strict";
/*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */ Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"h9cuS":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"f0369f0173e40550":"8z5Q2","dd2d5fab8dc388cf":"fuxLy"}],"8z5Q2":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"96995f5a2c2249c4":"6RgJr","c59c675893fdf798":"fuxLy"}],"6RgJr":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"cd7yM":[function(require,module,exports,__globalThis) {
...
},{}],"lnaDd":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"2008965cb9c2430b":"k0xcN","16eabe3b4792ec22":"fCz7j","bb4612fd79b5519f":"hOJSh"}],"k0xcN":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"357be8548bd6f2fb":"hOJSh"}],"hOJSh":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"fCz7j":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"2aa1599dd9180bdc":"k0xcN","73a79c40b33f1f5f":"hOJSh"}],"lXF0m":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"93240c83fe2b64be":"k0xcN","4bc7624fcda0dfdf":"7hEiA","9d5797bedbdd6e1f":"eo3v9","1988b7058434e360":"hOJSh"}],"7hEiA":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"c97f2deac84d7ec9":"hOJSh","989a64bbfc29f1fc":"k0xcN"}],"eo3v9":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"28eede09089fab5b":"hOJSh","7e60b3e5ff53101e":"k0xcN"}],"5Xutc":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.hkdf = exports.expand = exports.extract = void 0;
const _assert_js_1 = require("787c57583f41a310");
const utils_js_1 = require("a64be684868362fa");
const hmac_js_1 = require("692a9250d4ee288f");
// HKDF (RFC 5869)
...
},{"787c57583f41a310":"6RgJr","a64be684868362fa":"fuxLy","692a9250d4ee288f":"higgt"}],"higgt":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"88de570f0f701cc6":"6RgJr","337359ae358d0fc":"fuxLy"}],"7tvw6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DEFAULT_PROXY", ()=>Q);
parcelHelpers.export(exports, "Invoice", ()=>B);
parcelHelpers.export(exports, "LN_ADDRESS_REGEX", ()=>X);
parcelHelpers.export(exports, "LightningAddress", ()=>Y);
parcelHelpers.export(exports, "MemoryStorage", ()=>ee);
parcelHelpers.export(exports, "NoStorage", ()=>te);
parcelHelpers.export(exports, "decodeInvoice", ()=>E);
parcelHelpers.export(exports, "fetchWithL402", ()=>oe);
parcelHelpers.export(exports, "fiat", ()=>he);
parcelHelpers.export(exports, "fromHexString", ()=>b);
parcelHelpers.export(exports, "generateZapEvent", ()=>H);
parcelHelpers.export(exports, "getEventHash", ()=>F);
parcelHelpers.export(exports, "getFiatBtcRate", ()=>se);
parcelHelpers.export(exports, "getFiatValue", ()=>ae);
parcelHelpers.export(exports, "getFormattedFiatValue", ()=>ue);
parcelHelpers.export(exports, "getSatoshiValue", ()=>ce);
parcelHelpers.export(exports, "isUrl", ()=>z);
parcelHelpers.export(exports, "isValidAmount", ()=>M);
parcelHelpers.export(exports, "l402", ()=>ie);
parcelHelpers.export(exports, "parseKeysendResponse", ()=>O);
parcelHelpers.export(exports, "parseL402", ()=>re);
parcelHelpers.export(exports, "parseLnUrlPayResponse", ()=>G);
parcelHelpers.export(exports, "parseNostrResponse", ()=>V);
parcelHelpers.export(exports, "sendBoostagram", ()=>Z);
parcelHelpers.export(exports, "serializeEvent", ()=>K);
parcelHelpers.export(exports, "validateEvent", ()=>C);
...
const { bech32: n, hex: o, utf8: i } = r, s = {
    bech32: "bc",
    pubKeyHash: 0,
    scriptHash: 5,
    ...
    n: BigInt(1e9),
    p: BigInt(1e12)
}, d = BigInt("2100000000000000000"), p = BigInt(1e11), m = {
    payment_hash: 1,
    payment_secret: 16,
    description: 13,
    payee: 19,
...
for(let e = 0, t = Object.keys(m); e < t.length; e++){
    const r = t[e], n = m[t[e]].toString();
    y[n] = r;
}
const w = {
    1: (e)=>o.encode(n.fromWordsUnsafe(e)),
    16: (e)=>o.encode(n.fromWordsUnsafe(e)),
    13: (e)=>i.encode(n.fromWordsUnsafe(e)),
    19: (e)=>o.encode(n.fromWordsUnsafe(e)),
    23: (e)=>o.encode(n.fromWordsUnsafe(e)),
    27: (e)=>o.encode(n.fromWordsUnsafe(e)),
    6: v,
    24: v,
    3: function(e) {
        const t = [];
        let r, i, s, a, c, u = n.fromWordsUnsafe(e);
        for(; u.length > 0;)r = o.encode(u.slice(0, 33)), i = o.encode(u.slice(33, 41)), s = parseInt(o.encode(u.slice(41, 45)), 16), a = parseInt(o.encode(u.slice(45, 49)), 16), c = parseInt(o.encode(u.slice(49, 51)), 16), u = u.slice(51), t.push({
            pubkey: r,
            short_channel_id: i,
            fee_base_msat: s,
    ...
    5: function(e) {
        ...
        for(; t.length < 2 * l.length;)t.push(!1);
        const r = {};
        l.forEach((e, n)=>{
            let o;
            o = t[2 * n] ? "required" : t[2 * n + 1] ? "supported" : "unsupported", r[e] = o;
        });
        const n = t.slice(2 * l.length);
        return r.extra_bits = {
            start_bit: 2 * l.length,
            bits: n,
...
function g(e) {
    return (t)=>({
            tagCode: parseInt(e),
            words: n.encode("unknown", t, Number.MAX_SAFE_INTEGER)
        });
}
function v(e) {
...
var b = function(e) {
    ...
    try {
        var t = function(e, t) {
            ...
            const r = [], i = n.decode(e, Number.MAX_SAFE_INTEGER);
            e = e.toLowerCase();
            const l = i.prefix;
            ...
            _ ? (U = function(e, t) {
                ...
                const o = BigInt(n), i = r ? o * p / f[r] : o * p;
                if ("p" === r && o % BigInt(10) !== BigInt(0) || i > d) throw new Error("Amount is outside of valid range");
                return i.toString();
            }(_ + P[3]), r.push({
                name: "amount",
                letters: P[2] + P[3],
            ...
            for(b = b.slice(7), r.push({
                ...
                D = y[e] || "unknown_tag", N = w[e] || g(e), b = b.slice(1), I = v(b.slice(0, 2)), b = b.slice(2), j = b.slice(0, I), b = b.slice(I), r.push({
                    name: D,
                    tag: E[0],
            ...
            r.push({
                ...
                value: o.encode(n.fromWordsUnsafe(x))
            ...
            for(let e in m)"route_hint" !== e && Object.defineProperty(S, e, {
                get: ()=>R(e)
            });
            return S;
            function R(e) {
...
const P = (e)=>e instanceof Uint8Array, A = (e)=>new DataView(e.buffer, e.byteOffset, e.byteLength), k = (e, t)=>e << 32 - t | e >>> t;
if (68 !== new Uint8Array(new Uint32Array([
    287454020
]).buffer)[0]) throw new Error("Non little-endian hardware is not supported");
const _ = /* @__PURE__ */ Array.from({
    length: 256
}, (e, t)=>t.toString(16).padStart(2, "0"));
function U(e) {
...
function L(e) {
    ...
    }(e)), !P(e)) throw new Error("expected Uint8Array, got " + typeof e);
    return e;
}
class D {
    clone() {
...
function N(e) {
    const t = (t)=>e().update(L(t)).digest(), r = e();
    return t.outputLen = r.outputLen, t.blockLen = r.blockLen, t.create = ()=>e(), t;
}
class I extends D {
    constructor(e, t, r, n){
        super(), this.blockLen = e, this.outputLen = t, this.padOffset = r, this.isLE = n, this.finished = !1, this.length = 0, this.pos = 0, this.destroyed = !1, this.buffer = new Uint8Array(e), this.view = A(this.buffer);
    }
    update(e) {
        x(this);
        const { view: t, buffer: r, blockLen: n } = this, o = (e = L(e)).length;
        for(let i = 0; i < o;){
...
const j = (e, t, r)=>e & t ^ e & r ^ t & r, S = /* @__PURE__ */ new Uint32Array([
    1116352408,
    1899447441,
    3049323471,
    3921009573,
...
class T extends I {
    ...
    process(e, t) {
        for(let r = 0; r < 16; r++, t += 4)$[r] = e.getUint32(t, !1);
        for(let e = 16; e < 64; e++){
            const t = $[e - 15], r = $[e - 2], n = k(t, 7) ^ k(t, 18) ^ t >>> 3, o = k(r, 17) ^ k(r, 19) ^ r >>> 10;
            $[e] = o + $[e - 7] + n + $[e - 16] | 0;
        }
        let { A: r, B: n, C: o, D: i, E: s, F: a, G: c, H: u } = this;
        for(let e = 0; e < 64; e++){
            const t = u + (k(s, 6) ^ k(s, 11) ^ k(s, 25)) + ((h = s) & a ^ ~h & c) + S[e] + $[e] | 0, l = (k(r, 2) ^ k(r, 13) ^ k(r, 22)) + j(r, n, o) | 0;
...
var B = /*#__PURE__*/ function() {
    ...
    try {
        ...
        return o && c.push([
            ...
            return t.id = F(t), Promise.resolve(a.signEvent(t));
        });
    } catch (i) {
...
function K(e) {
    if (!C(e)) throw new Error("can't serialize event with wrong or missing properties");
    return JSON.stringify([
        0,
        e.pubkey,
        e.created_at,
...
var q = /((([A-Za-z]{3,9}:(?:\/\/)?)(?:[-;:&=+$,\w]+@)?[A-Za-z0-9.-]+|(?:www.|[-;:&=+$,\w]+@)[A-Za-z0-9.-]+)((?:\/[+~%/.\w-_]*)?\??(?:[-+=&;%@.\w_]*)#?(?:[\w]*))?)/, z = function(e) {
    return !!e && q.test(e);
}, M = function(e) {
    var t = e.amount;
    ...
    try {
        ...
        if (!z(t)) throw new Error("Callback must be a valid url");
        ...
        try {
            r = JSON.parse(e.metadata + ""), n = U(W(e.metadata + ""));
        } catch (e) {
            r = [], n = U(W("[]"));
        }
...
var Z = function(e, t) {
...
}, X = /^((?:[^<>()[\]\\.,;:\s@"]+(?:\.[^<>()[\]\\.,;:\s@"]+)*)|(?:".+"))@((?:\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(?:(?:[a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, Q = "https://api.getalby.com/lnurl", Y = /*#__PURE__*/ function() {
    function e(e, t) {
    ...
    return t.parse = function() {
        var e = X.exec(this.address.toLowerCase());
        ...
        try {
            var t, r = function(e) {
                ...
                if (n.options.proxy) return Promise.resolve(fetch(n.options.proxy + "/generate-invoice?" + new URLSearchParams(J({
                    ln: n.address
                ...
                if (!n.lnurlpData.callback || !z(n.lnurlpData.callback)) throw new Error("Valid callback does not exist in lnurlpData");
        ...
        try {
            var t = this, r = function() {
                if (e) return Promise.resolve(G(e)).then(function(e) {
                    t.lnurlpData = e;
                });
            }();
            return Promise.resolve(r && r.then ? r.then(function() {}) : void 0);
        ...
        e && (this.keysendData = O(e));
    }, t.parseNostrResponse = function(e) {
        if (e) {
            var t = V(e, this.username);
    ...
    var t = e.satoshi;
    return Promise.resolve(se(e.currency)).then(function(e) {
        return Number(t) * e;
    });
}, ce = function(e) {
    var t = e.amount;
    ...
    return r || (r = "en"), Promise.resolve(ae({
        satoshi: e.satoshi,
        currency: t
    })).then(function(e) {
    ...
    getFiatValue: ae,
    getSatoshiValue: ce,
    getFormattedFiatValue: ue
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cZjL6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Wallet Management Module
parcelHelpers.export(exports, "WalletManager", ()=>WalletManager);
var _sdk = require("@getalby/sdk");
class WalletManager {
    constructor(){
        this.wallets = {
    ...
    async connectWallet(walletId) {
        ...
        try {
            ...
            this.wallets[walletId].nwcClient = new (0, _sdk.nwc).NWCClient({
...
},{"@getalby/sdk":"9bLk3","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hlYsv":[function(require,module,exports,__globalThis) {
// Bitcoin Price Management Module
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PriceManager", ()=>PriceManager);
class PriceManager {
    constructor(){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"iDngy":[function(require,module,exports,__globalThis) {
// Balance Stabilization Manager Module
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "StabilizationManager", ()=>StabilizationManager);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["4VbKx","agb61"], "agb61", "parcelRequireed78", {})

//# sourceMappingURL=nwc.397c74d2.js.map
